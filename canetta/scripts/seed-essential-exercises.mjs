...
const { data: exercises, error } = await supabase.from("canetta_exercises").select("id,name,production_eligible,name_pt_status,taxonomy_status,media_verified,primary_pattern,exercise_tier,is_hybrid").limit(2000);
