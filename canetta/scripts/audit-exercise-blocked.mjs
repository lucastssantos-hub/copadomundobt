...
const { data, error } = await supabase.from("canetta_exercises").select("external_id,name,name_pt,name_pt_status,media_verified,production_eligible,primary_pattern,movement_family,valid_slots,exercise_tier,is_hybrid,technical_complexity").limit(2000);
